...
export const Ready = <T extends Show>(data: T) =>
  new CasePayload("Ready" as const, data);
export const Failure = <E extends Show>(error: E) =>
  new CasePayload("Error" as const, error);
